...
cifar10_train = CustomDataset("sample_train.csv", "data/images", transform=train_transform)
cifar10_unlabeled  = CustomDataset("sample_train.csv", "data/images", transform=test_transform)
cifar10_test  = CustomDataset("sample_test.csv", "data/images", transform=test_transform)
...
if __name__ == '__main__':
    ...
    for trial in range(TRIALS):
        ...
        test_loader  = DataLoader(cifar10_test, batch_size=BATCH, drop_last=True)
        dataloaders  = {'train': train_loader, 'test': test_loader}
        
        # Model
        resnet18    = resnet.ResNet18(num_classes=15).cuda()
